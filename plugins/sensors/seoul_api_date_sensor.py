...
class SeoulApiDateSensor(BaseSensorOperator):
    ...
    def __init__(self, dateset_nm, base_dt_col, day_off = 0, **kwargs):
        '''
        ...
        self.endpoint = '{{var.value.api_key_openai_seoul_go_kr}}/json' + dateset_nm + '/1/100' # 100건만 추출
    ...
    def poke(self, context):
        ...
        search_ymd = (context.get('date_interval_end').in_timezone('Asia/Seoul') + relativedelta(days=self.day_off)).strftime('%Y-%m-%d')
        try:
            import pendulum
